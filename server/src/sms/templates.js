module.exports = (type, user) => {
  ...
  const template = {
    ...
    FirstNutritionReminder: `שלום, לקראת הבדיקה שלך ביוספטל בתאריך ${date.getDate()}/${
      date.getMonth() + 1
    ...
    SecondNutritionReminder: `שלום, לקראת הבדיקה שלך בעוד יומיים ביוספטל, זאת תזכורת ש 24 שעות לפני הבדיקה שלך,  עליך לעבור לתזונה נוזלית בלבד ולהתחיל לקחת מרוקנים לניקוי המעי לפי הנחיית הרופא/ה. הכנה טובה חיונית להצלחת הבדיקה. יש ללחוץ על הקישור לקריאת ההנחיות.\n${startLink}`,
  };
